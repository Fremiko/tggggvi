...
`OPENAI_API_KEY` is not required for deploy. Without it the bot still starts and uses local fallback commands: calculator, equations, summaries, mini-translation, notes, reminders and games.
...
- AI commands: `/ai`, `/ask`, `/solve`, `/analyze`, `/summary`, `/translate`.
